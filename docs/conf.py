...
htmlhelp_basename = 'PythonCASdoc'
...
latex_documents = [
  ('index', 'PythonCAS.tex', 'Python CAS Documentation',
   'Ming Chen', 'manual'),
]
...
texinfo_documents = [
  ('index', 'PythonCAS', 'Python CAS Documentation',
   'Ming Chen', 'PythonCAS', 'One line description of project.',
   'Miscellaneous'),
]
